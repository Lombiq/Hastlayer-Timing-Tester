...
namespace HastlayerTimingTester
{
    ...
    internal class TimingTester
    {
        ...
        public void DoTests(TimingTestConfigBase testConfig, ProgramParameters parameters)
        {
            ...
            _testConfig.Driver.CurrentRootDirectoryPath = CurrentTestBaseDirectory;
        ...
        private void PrepareAnalyze(TaskChoice taskChoice)
        {
            ...
            {
                batchWriter = new StreamWriter(File.Open(CombineWithBaseDirectoryPath("Run.bat"), FileMode.Create))
                {
                    AutoFlush = true
                };
                        ...
                        foreach (var inputDataTypeFunction in op.DataTypes)
                        {
                            foreach (var vhdlTemplate in op.VhdlTemplates)
                            {
                                try
                                {
                                    ...
                                    Directory.CreateDirectory(CombineWithBaseDirectoryPath(testFriendlyName));
        ...
        protected string CombineWithBaseDirectoryPath(params string[] subPaths) =>
