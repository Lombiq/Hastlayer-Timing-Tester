...
namespace HastlayerTimingTester.Vhdl.Expressions
{
    ...
    /// For example, those operators that normally required <see cref="VhdlOp.DoubleSizedOutput"/> can now work with
    /// <see cref="VhdlOp.SameOutputDataType"/> using WeapSmartResizeVhdlExpression.
    /// </summary>
