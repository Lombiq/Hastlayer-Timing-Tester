...
internal class UnaryOperatorVhdlExpression : VhdlExpressionBase
{
    ...
    /// this class might generate test cases for a wide range of operators. Note that because of this a lot of cases
    /// will fail with something like "0 definitions of operator "+" match here".
    /// </summary>
