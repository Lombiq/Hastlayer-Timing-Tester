...
namespace HastlayerTimingTester
{
    ...
    {
        [Option('p', "prepare", Required = false, DefaultValue = false, HelpText = "Generate VHDL files and batch file for next step.")]
        ...
        [Option('x', "all", DefaultValue = false, HelpText = "Run all of the above.")]
