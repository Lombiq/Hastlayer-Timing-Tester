...
/// <summary>
/// Logger writes a formatted string to both a log file (Log.txt in CurrentTestOutputBaseDirectory) and the console. It
/// also handles writing to the results file (Results.tsv in CurrentTestOutputBaseDirectory).
/// </summary>
internal static class Logger
{
    ...
    /// <summary>
    /// Initializes the Logger, to open the file given in LogFilePath. (Logger already works before initialization, but
    /// it only writes to the console.)
    /// </summary>
