...
/// <summary>
/// Configuration for Microsoft's Project Catapult. Altera (Intel) Quartus Prime and TimeQuest, version 15.1 are needed
/// and optionally also Python 2.7 (https://www.python.org/downloads/) for running Cleanup.py.
/// </summary>
